...
(cl:defmethod cl:initialize-instance :after ((m <Bspline>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Bspline)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name plan_manage-msg:<Bspline> is deprecated: use plan_manage-msg:Bspline instead.")))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_manage-msg:order-val is deprecated.  Use plan_manage-msg:order instead.")
  (order m))

(cl:ensure-generic-function 'traj_id-val :lambda-list '(m))
(cl:defmethod traj_id-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_manage-msg:traj_id-val is deprecated.  Use plan_manage-msg:traj_id instead.")
  (traj_id m))

(cl:ensure-generic-function 'start_time-val :lambda-list '(m))
(cl:defmethod start_time-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_manage-msg:start_time-val is deprecated.  Use plan_manage-msg:start_time instead.")
  (start_time m))

(cl:ensure-generic-function 'knots-val :lambda-list '(m))
(cl:defmethod knots-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_manage-msg:knots-val is deprecated.  Use plan_manage-msg:knots instead.")
  (knots m))

(cl:ensure-generic-function 'pos_pts-val :lambda-list '(m))
(cl:defmethod pos_pts-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_manage-msg:pos_pts-val is deprecated.  Use plan_manage-msg:pos_pts instead.")
  (pos_pts m))

(cl:ensure-generic-function 'yaw_pts-val :lambda-list '(m))
(cl:defmethod yaw_pts-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_manage-msg:yaw_pts-val is deprecated.  Use plan_manage-msg:yaw_pts instead.")
  (yaw_pts m))

(cl:ensure-generic-function 'yaw_dt-val :lambda-list '(m))
(cl:defmethod yaw_dt-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader plan_manage-msg:yaw_dt-val is deprecated.  Use plan_manage-msg:yaw_dt instead.")
  (yaw_dt m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Bspline>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'yaw_dt))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Bspline>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'yaw_pts)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'yaw_dt) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Bspline>)))
  ...
  "b352d4f7278a546180de67cbe6793e49")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Bspline)))
  "Returns md5sum for a message object of type 'Bspline"
  "b352d4f7278a546180de67cbe6793e49")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Bspline>)))
  ...
  (cl:format cl:nil "int32 order                         #阶数~%int64 traj_id                       #该段轨迹编号~%time start_time                     #该段轨迹开始时间~%~%float64[] knots                     #位置控制点的节点向量，因为是非均匀的，所以必须要这个~%geometry_msgs/Point[] pos_pts       #位置控制点（三维的）~%~%float64[] yaw_pts                   #yaw角控制点~%float64 yaw_dt                      #yaw角控制点的间隔，因为是均匀的，所以只需要这个就可以了~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Bspline)))
  "Returns full string definition for message of type 'Bspline"
  (cl:format cl:nil "int32 order                         #阶数~%int64 traj_id                       #该段轨迹编号~%time start_time                     #该段轨迹开始时间~%~%float64[] knots                     #位置控制点的节点向量，因为是非均匀的，所以必须要这个~%geometry_msgs/Point[] pos_pts       #位置控制点（三维的）~%~%float64[] yaw_pts                   #yaw角控制点~%float64 yaw_dt                      #yaw角控制点的间隔，因为是均匀的，所以只需要这个就可以了~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
